from F3Net.xception import Xception
import torch
...
def get_xcep_state_dict(pretrained_path='/home/oem/deepfake/Ourmethod/comparison/F3Net/pretrained/xception-b5690688.pth'):
    # load Xception
