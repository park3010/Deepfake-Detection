...
- EarlyStopping, Resume, per-epoch ckpt save
...
def build_model(backbone: str, num_classes: int, pretrained: bool, in_ch: int, convnext_cbam: bool) -> nn.Module:
    ...
    # ConvNeXtV2 Tiny/Nano (your custom implementation supports in_chans/num_classes/use_cbam)
    ...
    raise ValueError("backbone must be one of: resnet50, resnet50_cbam, convnextv2_tiny, convnextv2_nano")
...
def main():
    ...
    es_ckpt = ckpt_dir / f"es_{args.backbone}_{args.stream}.pth"
        ...
        for ep in range(start_epoch, args.epochs + 1):
            ...
            if va_m["f1"] > best_f1:
                ...
                torch.save(
                    ...
                    ckpt_dir / f"best_{args.backbone}_{args.stream}.pth",
                )
                print(" ▶ best ckpt 저장")
