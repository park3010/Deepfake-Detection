...
#             '/home/oem/deepfake/FaceForensics/pretrained/xception-b5690688.pth')
...
class TransferModel(nn.Module):
    ...
    """
    def __init__(self, modelchoice, num_out_classes=2, pretrained=True, dropout=0.0, use_cbam=False):
        ...
        if modelchoice == 'xception':
            ...
            self.model = xception(num_classes=num_out_classes,
                                  pretrained='imagenet' if pretrained else None, use_cbam=use_cbam)
            # Replace fc
...
def model_selection(modelname, num_out_classes, pretrained=True, dropout=0.0, use_cbam=False):
    """
    :param modelname:
    :return: model, image size, pretraining<yes/no>, input_list
    """
    if modelname == 'xception':
        return TransferModel('xception', num_out_classes, pretrained, dropout, use_cbam), 224, True, ['image'], None
